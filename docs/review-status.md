...
- [ ] [부동소수점 — 0.1 + 0.2가 0.3이 아닌 이유](../src/content/posts/floating-point-basics/index.md)
...
- [ ] [PostgreSQL numeric과 double precision](../src/content/posts/postgresql-numeric-vs-double/index.md)
