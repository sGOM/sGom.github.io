...
전면적으로 잡는 대신 손대는 김에 조금씩 고치는 방식을 파울러는 [Opportunistic Refactoring](https://martinfowler.com/bliki/OpportunisticRefactoring.html)이라 부른다. 캠프장 규칙, 발견했을 때보다 나은 상태로 두고 나온다는 그 방식이다. 대신 파고들어 원래 작업을 놓치지 않는 선을 지켜야 한다.
